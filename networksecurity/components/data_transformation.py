...
class DataTransformation():
    ...
    def get_data_transformer(self) -> Pipeline:
        logging.info("Entered get_data_transformer object of transformation class")
        try:
    ...
    def initiate_data_transformation(self)-> DataTransformationArtifact:
        ...
        try:
            ...
            transformed_train_data = processor_object.transform(input_feature_train_df)
            transformed_test_data = processor_object.transform(input_feature_test_df)
            ...
            save_object("final_model/preprocesor.pkl" , processor_object)
